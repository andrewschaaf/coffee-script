(function() {
  ...
  o = function(patternString, action, options) {
    ...
    action = action.replace(/\b(new )([a-zA-Z0-9_]+)(\(?)/g, (function(g0, g1, name, paren) {
      return ["(function(q,w,e,r,t,y,u,i,o,p){", "var x = new yy." + name + "(q,w,e,r,t,y,u,i,o,p);", "x.lineno = yylineno + 1;", "for(var i = 0, len=arguments.length; i < len; i++) {", "if (arguments[i] && arguments[i].lineno && arguments[i].lineno < x.lineno) {", "x.lineno = arguments[i].lineno;", "}", "};", "return x;", "})" + (paren ? '(' : '()')].join('');
    }));
