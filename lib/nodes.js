(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      ...
      if (this.compile_bar != null) {
        strings = [];
        processBarArray(o, strings, this.compile_bar(o, lvl));
        return strings.join('');
      } else {
        o = extend({}, o);
        if (lvl) {
  ...
  exports.Return = Return = (function() {
    ...
    Return.prototype.compileNode_bar = function(o) {
      if (this.expression) {
        return ["" + this.tab + "return ", PAREN(this.expression), ";"];
      } else {
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile_bar = function(o) {
      return [(this.proto ? '.prototype' : '') + "[", PAREN(this.index), "]"];
    };
  ...
  exports.While = While = (function() {
    ...
    While.prototype.compileNode_bar = function(o) {
      var body, set;
      o.indent += TAB;
      set = '';
      body = this.body;
  ...
  exports.Parens = Parens = (function() {
    ...
    Parens.prototype.compileNode_bar = function(o) {
      var arr, bare, expr;
