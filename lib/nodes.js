(function() {
  var ACCESS, Access, Arr, Assign, Base, COND, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, LIST, Literal, NEGATE, NO, OP, Obj, Op, PAREN, Param, Parens, Push, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, TOP, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, processBarArray, starts, unfoldSoak, utility, _ref;
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      var code, node, strings;
      if (this.compile_bar != null) {
        strings = [];
        this.bar = this.compile_bar(o, lvl);
        processBarArray(o, strings, this.bar);
        return strings.join('');
      } else {
        o = extend({}, o);
        if (lvl) {
        ...
        node.tab = o.indent;
        code = o.level === LEVEL_TOP || !node.isStatement(o) ? node.compileNode(o) : node.compileClosure(o);
        if (!(this.bar != null)) {
          this.bar = [code];
        }
        return code;
    ...
    Base.prototype.compileNode = function(o, lvl) {
      var strings;
      if (this.compileNode_bar != null) {
        strings = [];
        processBarArray(o, strings, this.compileNode_bar(o, lvl));
        return strings.join('');
      } else {
        throw new Error("Expected " + this.constructor.name + " to have compileNode or compileNode_bar");
      }
    };
  ...
  exports.Expressions = Expressions = (function() {
    ...
    Expressions.prototype.compile = function(o, level) {
      ...
      code = o.scope ? Expressions.__super__.compile.call(this, o, level) : this.compileRoot(o);
      if (!(this.bar != null)) {
        this.bar = [code];
      }
      return code;
  ...
  exports.Literal = Literal = (function() {
    ...
    Literal.prototype.compileNode_bar = function(o) {
      var code;
  ...
  exports.Return = Return = (function() {
    ...
    Return.prototype.compile = function(o, level) {
      ...
      code = expr && !(expr instanceof Return) ? expr.compile(o, level) : Return.__super__.compile.call(this, o, level);
      if (!(this.bar != null)) {
        this.bar = [code];
      }
      return code;
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.compileNode_bar = function(o) {
      var arr, prop, props, _i, _len;
      this.base.front = this.front;
      props = this.properties;
      arr = props.length ? [ACCESS(this.base)] : [this.base];
  ...
  exports.Comment = Comment = (function() {
    ...
    Comment.prototype.compileNode_bar = function(o, level) {
      var code;
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.compileNode_bar = function(o) {
      var arg, args, code, i, _len, _ref, _ref2;
      if ((_ref = this.variable) != null) {
        _ref.front = this.front;
      }
      if (code = Splat.compileSplattedArray(o, this.args, true)) {
        return this.compileSplat_bar(o, code);
      }
      args = [];
      _ref2 = this.args;
      ...
      if (this.isSuper) {
        return [this.superReference(o), ".call(this", (this.args.length ? [', ', args] : ''), ")"];
      } else {
        this.variable.compile(o, LEVEL_ACCESS);
        return [(this.isNew ? 'new ' : ''), this.variable, "(", args, ")"];
      }
    };
    Call.prototype.compileSuper = function(args, o) {
      return "" + (this.superReference(o)) + ".call(this" + (args.length ? ', ' : '') + args + ")";
    };
    Call.prototype.compileSplat_bar = function(o, splatArgs) {
      var base, fun, funCode, idt, name, ref;
      if (this.isSuper) {
        return ["" + (this.superReference(o)) + ".apply(this, ", splatArgs, ")"];
      }
      if (this.isNew) {
        idt = this.tab + TAB;
        return ["(function(func, args, ctor) {\n" + idt + "ctor.prototype = func.prototype;\n" + idt + "var child = new ctor, result = func.apply(child, args);\n" + idt + "return typeof result == \"object\" ? result : child;", "" + this.tab + "})(", LIST(this.variable), ", ", splatArgs, ", function() {})"];
      }
  ...
  exports.Extends = Extends = (function() {
    ...
    Extends.prototype.compile = function(o) {
      var code;
      utility('hasProp');
      code = new Call(new Value(new Literal(utility('extends'))), [this.child, this.parent]).compile(o);
      if (!(this.bar != null)) {
        this.bar = [code];
      }
      return code;
  ...
  exports.Access = Access = (function() {
    ...
    Access.prototype.compile_bar = function(o) {
      var name;
      name = this.name.compile(o);
      if (IS_STRING.test(name)) {
        return ["" + this.proto + "[", this.name, "]"];
      } else {
        return ["" + this.proto + ".", this.name];
      }
    };
  ...
  exports.Param = Param = (function() {
    ...
    Param.prototype.compile = function(o) {
      var code;
      code = this.name.compile(o, LEVEL_LIST);
      if (!(this.bar != null)) {
        this.bar = [code];
      }
      return code;
  ...
  exports.Splat = Splat = (function() {
    ...
    Splat.prototype.compile = function(o) {
      var code;
      code = this.index != null ? this.compileParam(o) : this.name.compile(o);
      if (!(this.bar != null)) {
        this.bar = [code];
      }
      return code;
    ...
    Splat.compileSplattedArray_bar = function(o, list, apply) {
      var arg, args, argsBar, base, first, i, index, node, _len, _len2, _len3, _ref, _ref2;
      index = -1;
      while ((node = list[++index]) && !(node instanceof Splat)) {
        continue;
      }
      ...
      for (i = 0, _len = args.length; i < _len; i++) {
        node = args[i];
        args[i] = node instanceof Splat ? [utility('slice', ".call(", LIST(node), ")")] : ["[", LIST(node), "]"];
      }
      if (index === 0) {
        argsBar = [];
        _ref = args.slice(1);
  ...
  exports.Throw = Throw = (function() {
    ...
    Throw.prototype.compileNode_bar = function(o) {
      return [this.tab + 'throw ', this.expression, ';'];
    };
    return Throw;
  })();
  exports.Existence = Existence = (function() {
    ...
    Existence.prototype.compileNode_bar = function(o) {
      var arr, code;
      code = this.expression.compile(o, LEVEL_OP);
      arr = IDENTIFIER.test(code) && !o.scope.check(code) ? this.negated ? ['typeof ', OP(this.expression), ' == "undefined" || ', OP(this.expression), ' === null'] : ['typeof ', OP(this.expression), ' != "undefined" && ', OP(this.expression), ' !== null'] : [OP(this.expression), (this.negated ? ' == null' : ' != null')];
  ...
  exports.Switch = Switch = (function() {
    ...
    Switch.prototype.compileNode_bar = function(o) {
      var arr, block, cond, conditions, expr, i, idt1, idt2, jumper, _i, _len, _len2, _ref, _ref2, _ref3, _ref4;
      idt1 = o.indent + TAB;
      idt2 = o.indent = idt1 + TAB;
      arr = [this.tab + ("switch (" + (((_ref = this.subject) != null ? _ref.compile(o, LEVEL_PAREN) : void 0) || false) + ") {\n")];
      _ref2 = this.cases;
      for (i = 0, _len = _ref2.length; i < _len; i++) {
  ...
  exports.If = If = (function() {
    ...
    If.prototype.compileNode_bar = function(o) {
      if (this.isStatement(o)) {
        return this.compileStatement_bar(o);
      } else {
        return this.compileExpression_bar(o);
      }
    };
    ...
    If.prototype.compileStatement_bar = function(o) {
      var body, bodyCode, bodyNode, child, cond, ifPart, unwrapped;
      child = del(o, 'chainChild');
      this.condition.compile(o, LEVEL_PAREN);
      cond = this.condition;
      o.indent += TAB;
      bodyNode = this.ensureExpressions(this.body);
      bodyCode = bodyNode.compile(o);
      body = bodyCode ? ["\n", bodyNode, "\n" + this.tab] : bodyNode;
      ifPart = ["" + (child ? "" : this.tab) + "if (", cond, ") {", body, "}"];
      if (!this.elseBody) {
        return [ifPart];
      }
      return [ifPart, ' else ', this.isChain ? (o.indent = this.tab, o.chainChild = true, unwrapped = this.elseBody.unwrap(), unwrapped.compile(o, LEVEL_TOP), unwrapped) : (this.elseBody.compile(o, LEVEL_TOP), ["{\n", this.elseBody, "\n" + this.tab + "}"])];
    };
    If.prototype.compileExpression_bar = function(o) {
      var arr, bodyNode, elseBodyNode;
      this.condition.compile(o, LEVEL_COND);
      bodyNode = this.bodyNode();
      bodyNode.compile(o, LEVEL_LIST);
      elseBodyNode = this.elseBodyNode();
      if (elseBodyNode) {
        elseBodyNode.compile(o, LEVEL_LIST);
      } else {
        elseBodyNode = 'void 0';
      }
      arr = [this.condition, " ? ", bodyNode, " : ", elseBodyNode];
      if (o.level >= LEVEL_COND) {
        return ["(", arr, ")"];
      } else {
        return arr;
  ...
  processBarArray = function(o, strings, arr) {
    ...
    for (_i = 0, _len = arr.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        if (x instanceof Array) {
          return processBarArray(o, strings, x);
        } else if ((typeof x) === 'string') {
          return strings.push(x);
        } else if (x instanceof Base) {
          if (x.bar) {
            return processBarArray(o, strings, x.bar);
          } else {
            return strings.push(x.compile(o));
          }
        } else if (x.level != null) {
          if (x.node.bar) {
            return processBarArray(o, strings, x.node.bar);
          } else {
            return strings.push(x.node.compile(o, x.level));
          }
        } else {
